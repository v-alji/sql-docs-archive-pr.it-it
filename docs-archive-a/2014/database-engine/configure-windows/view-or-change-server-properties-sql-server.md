...
4.  Nella finestra di dialogo **Proprietà - SQL Server (\<***instancename***>)** , modificare le proprietà del server nella scheda **Servizio** o **Avanzate** e fare quindi clic su **OK**.  
