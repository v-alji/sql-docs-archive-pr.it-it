...
4.  Nella casella **Porta TCP** dell'area **Proprietà** **IP**_n_ immettere il numero di porta su cui deve rimanere in attesa questo indirizzo IP e quindi fare clic su **OK**.  
