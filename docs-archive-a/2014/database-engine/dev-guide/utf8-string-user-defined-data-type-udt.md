...
3.  In c:\MySample creare `Utf8String.vb` (per l'esempio Visual Basic) o `Utf8String.cs` (per l'esempio C#) e copiare nel file il codice di esempio appropriato, Visual Basic o C#, riportato di seguito.  
