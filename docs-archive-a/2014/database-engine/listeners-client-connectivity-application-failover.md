...
###  <a name="availability-group-listener-configuration"></a><a name="AGlConfig"></a> Configurazione del listener del gruppo di disponibilità  
...
###  <a name="selecting-an-availability-group-listener-port"></a><a name="SelectListenerPort"></a> Selezione della porta per il listener del gruppo di disponibilità  
...
##  <a name="using-a-listener-to-connect-to-the-primary-replica"></a><a name="ConnectToPrimary"></a>Uso di un listener per connettersi alla replica primaria  
...
##  <a name="using-a-listener-to-connect-to-a-read-only-secondary-replica-read-only-routing"></a><a name="ConnectToSecondary"></a> Utilizzo di un listener per connettersi a una replica secondaria di sola lettura (routing di sola lettura)  
...
###  <a name="to-configure-availability-replicas-for-read-only-routing"></a><a name="ConfigureARsForROR"></a> Per configurare repliche di disponibilità per il routing di sola lettura  
...
####  <a name="related-tasks"></a><a name="RelatedTasksROR"></a> Attività correlate  
  
-   [Configurare l'accesso in sola lettura in una replica di disponibilità &#40;SQL Server&#41;](availability-groups/windows/configure-read-only-access-on-an-availability-replica-sql-server.md)  
  
-   [Configurare il routing di sola lettura per un gruppo di disponibilità &#40;SQL Server&#41;](availability-groups/windows/configure-read-only-routing-for-an-availability-group-sql-server.md)  
  
###  <a name="read-only-application-intent-and-read-only-routing"></a><a name="ReadOnlyAppIntent"></a>Finalità dell'applicazione di sola lettura e routing di sola lettura  
...
####  <a name="related-tasks"></a><a name="RelatedTasksApps"></a> Attività correlate  
...
##  <a name="bypassing-availability-group-listeners"></a><a name="BypassAGl"></a>Ignorare i listener del gruppo di disponibilità  
...
##  <a name="behavior-of-client-connections-on-failover"></a><a name="CCBehaviorOnFailover"></a>Comportamento delle connessioni client al failover  
...
##  <a name="supporting-availability-group-multi-subnet-failovers"></a><a name="SupportAgMultiSubnetFailover"></a> Supporto del failover su più subnet del gruppo di disponibilità  
...
##  <a name="availability-group-listeners-and-ssl-certificates"></a><a name="SSLcertificates"></a> Listener del gruppo di disponibilità e certificati SSL  
...
##  <a name="availability-group-listeners-and-server-principal-names-spns"></a><a name="SPNs"></a>Listener del gruppo di disponibilità e nomi dell'entità server (SPN)  
...
-   [Visualizzare le proprietà del listener del gruppo di disponibilità &#40;SQL Server&#41;](availability-groups/windows/view-availability-group-listener-properties-sql-server.md)  
