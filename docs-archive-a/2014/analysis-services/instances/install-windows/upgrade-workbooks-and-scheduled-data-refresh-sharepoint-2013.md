...
##  <a name="overview-of-upgrading-workbooks"></a><a name="bkmk_overview"></a>Panoramica dell'aggiornamento delle cartelle di lavoro  
...
##  <a name="upgrade-to-office-2013-workbooks-from-versions-created-by-using-the-2012-powerpivot-add-in-for-excel"></a><a name="bkmk_to_2012sp1_from_2012"></a>Eseguire l'aggiornamento a cartelle di lavoro di Office 2013 da versioni create tramite il componente aggiuntivo 2012 PowerPivot per Excel  
...
##  <a name="upgrade-to-sql-server-2012-workbooks-from-versions-created-by-using-the-2008-r2-powerpivot-add-in-for-excel-2010"></a><a name="bkmk_to_2012_from_2008R2"></a>Eseguire l'aggiornamento a SQL Server cartelle di lavoro di 2012 da versioni create tramite il componente aggiuntivo 2008 R2 PowerPivot per Excel 2010  
...
##  <a name="running-multiple-workbook-versions-on-a-newer-server"></a><a name="bkmk_runold"></a> Esecuzione di più versioni di cartelle di lavoro in un server più recente  
...
###  <a name="how-to-check-for-msolap-data-provider-information-in-a-powerpivot-workbook"></a><a name="bkmk_msolapxslx"></a>Come verificare la presenza di MSOLAP provider di dati informazioni in una cartella di lavoro di PowerPivot  
...
###  <a name="how-to-check-for-the-current-version-of-the-msolap-data-provider-on-a-local-computer"></a><a name="bkmk_msolappc"></a> Procedura di verifica della versione corrente del provider di dati MSOLAP su un computer locale  
