...
##  <a name="allow-analysis-services-to-impersonate-a-user-identity"></a><a name="bkmk_impersonate"></a>Consenti Analysis Services di rappresentare un'identità utente  
...
##  <a name="configure-analysis-services-for-trusted-delegation"></a><a name="bkmk_delegate"></a>Configurare Analysis Services per la delega Trusted  
...
-   Verificare che il nome SPN registrato per Analysis Services sia valido. Per istruzioni, vedere [SPN registration for an Analysis Services instance](spn-registration-for-an-analysis-services-instance.md)  
...
##  <a name="test-for-impersonated-or-delegated-identity"></a><a name="bkmk_test"></a>Test per identità rappresentata o delegata  
