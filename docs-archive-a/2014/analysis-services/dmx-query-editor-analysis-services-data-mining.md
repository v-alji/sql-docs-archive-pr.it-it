...
|**Parse**.|Consente di controllare la sintassi del codice selezionato. Se non è stato selezionato alcun codice, questa opzione controlla la sintassi dell'intera finestra dell'Editor di query DMX.|  
