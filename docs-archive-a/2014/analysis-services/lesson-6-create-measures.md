...
1.  Usare la funzionalità Somma automatica e creare le misure seguenti con i nomi indicati:  
    ...
    |Internet Total Units|Order Quantity|Somma|=SUM([Order Quantity])|  
    |Internet Total Discount Amount|Discount Amount|Somma|=SUM([Discount Amount])|  
    |Internet Total Product Cost|Total Product Cost|Somma|=SUM([Total Product Cost])|  
    |Internet Total Sales|Sales Amount|Somma|=SUM([Sales Amount])|  
    |Internet Total Margin|Margin|Somma|=SUM([Margin])|  
    |Internet Total Tax Amt|Tax Amt|Somma|=SUM([Tax Amt])|  
    |Internet Total Freight|Freight|Somma|=SUM([Freight])|  
