...
|**SQL Server**|Utilizza un meccanismo di traccia specializzato in [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] per identificare le modifiche apportate alle tabelle sottostanti per l'oggetto.|  
