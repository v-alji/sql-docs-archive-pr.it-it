...
##  <a name="basic-prediction-query-design"></a><a name="bkmk_PredQuery"></a> Progetto di query di stima di base  
...
###  <a name="adding-prediction-functions"></a><a name="bkmk_PredFunc"></a>Aggiunta di funzioni di stima  
...
###  <a name="creating-singleton-prediction-queries"></a><a name="bkmk_SingletonQuery"></a>Creazione di query di stima singleton  
...
###  <a name="batch-prediction-queries"></a><a name="bkmk_BatchQuery"></a> Query di stima in batch  
...
###  <a name="predictions-in-time-series-mining-models"></a><a name="bkmk_TSQuery"></a> Stime nei modelli di data mining Time Series  
...
##  <a name="working-with-the-results-of-a-prediction-query"></a><a name="bkmk_WorkResults"></a> Utilizzo dei risultati di una query di stima  
