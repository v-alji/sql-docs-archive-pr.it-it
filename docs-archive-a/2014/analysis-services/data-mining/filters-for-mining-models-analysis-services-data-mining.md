...
### <a name="why-cant-i-see-any-effects-from-the-filter"></a>Perché non è possibile visualizzare gli effetti del filtro?  
...
## <a name="related-resources"></a>Risorse correlate  
 Per altre informazioni sulla sintassi dei filtri e per esempi delle espressioni di filtro, vedere [Sintassi ed esempi di filtri dei modelli &#40;Analysis Services - Data mining&#41;](model-filter-syntax-and-examples-analysis-services-data-mining.md).  
