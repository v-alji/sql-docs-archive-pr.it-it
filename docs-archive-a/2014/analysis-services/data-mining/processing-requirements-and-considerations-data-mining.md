...
##  <a name="queries-on-the-relational-store-during-processing"></a><a name="bkmk_QueryReqs"></a>Query sull'archivio relazionale durante l'elaborazione  
...
##  <a name="processing-mining-structures"></a><a name="bkmk_ProcessStructures"></a>Elaborazione di strutture di data mining  
...
##  <a name="processing-mining-models"></a><a name="bkmk_ProcessModels"></a> Elaborazione di modelli di data mining  
