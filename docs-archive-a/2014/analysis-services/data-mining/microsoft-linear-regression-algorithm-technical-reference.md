...
|---------------|------------------------|--------------|  
|Linear Regression|Punteggio di interesse|Predefinita.<br /><br /> Gli altri metodi relativi alla caratteristica di selezione degli attributi disponibili con l'algoritmo Decision Trees si applicano solo alle variabili discrete e non sono pertanto validi per i modelli di regressione lineare.|  
