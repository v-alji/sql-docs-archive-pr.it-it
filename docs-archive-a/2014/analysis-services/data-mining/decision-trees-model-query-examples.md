...
##  <a name="finding-information-about-a-decision-trees-model"></a><a name="bkmk_top2"></a> Ricerca di informazioni su un modello Decision Trees  
...
###  <a name="sample-query-1-retrieving-model-parameters-from-the-data-mining-schema-rowset"></a><a name="bkmk_Query1"></a> Esempio di query 1: Recupero di parametri di modello dal set di righe dello schema di data mining  
...
###  <a name="sample-query-2-returning-details-about-the-model-content-by-using-dmx"></a><a name="bkmk_Query2"></a> Esempio di query 2: Restituzione di dettagli sul contenuto del modello tramite DMX  
...
###  <a name="sample-query-3-retrieving-subtrees-from-the-model"></a><a name="bkmk_Query3"></a> Esempio di query 3: Recupero di sottoalberi dal modello  
...
###  <a name="sample-query-4-returning-predictions-with-probabilities"></a><a name="bkmk_Query4"></a> Esempio di query 4: Restituzione di stime con probabilità  
...
###  <a name="sample-query-5-predicting-associations-from-a-decision-trees-model"></a><a name="bkmk_Query5"></a> Esempio di query 5: Stima delle associazioni da un modello Decision Trees  
...
###  <a name="sample-query-6-retrieving-a-regression-formula-from-a-decision-trees-model"></a><a name="bkmk_Query6"></a> Esempio di query 6: Recupero di una formula di regressione da un modello Decision Trees  
...
||57220,8876687257|0|0|1041216662.54387|11|  
 ...
 Per altre informazioni sui tipi di valore e le statistiche usate nei modelli di regressione, vedere [Contenuto dei modelli di data mining per i modelli di regressione lineare &#40;Analysis Services - Data mining&#41;](mining-model-content-for-linear-regression-models-analysis-services-data-mining.md).  
