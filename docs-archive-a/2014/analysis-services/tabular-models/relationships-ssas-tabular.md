...
-   [Valori duplicati e altri errori](#bkmk_dupl_errors)  
...
|CustomerID|Nome|EMail|DiscountRate|OrderID|OrderDate|Product|Quantità|  
|----------------|----------|-----------|------------------|-------------|---------------|-------------|--------------|  
...
|[CustomerID]|OrderID|OrderDate|Product|Quantità|  
|--------------------|-------------|---------------|-------------|--------------|  
