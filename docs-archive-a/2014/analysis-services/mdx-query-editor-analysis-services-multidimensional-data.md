...
|**Parse**.|Consente di controllare la sintassi del codice selezionato. Nel caso in cui non sia stato selezionato alcun codice, viene controllata la sintassi dell'intera finestra dell'Editor di query MDX.|  
