...
```  
 ...
 Non è possibile combinare un termine di prossimità generico con un termine di prossimità personalizzato, ad esempio `NEAR((term1,term2),5)` , un termine ponderato (noabout...) o un termine generazionale (FORMSOF...).  
