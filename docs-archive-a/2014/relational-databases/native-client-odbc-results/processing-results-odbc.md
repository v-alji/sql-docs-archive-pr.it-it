...
# <a name="processing-results-odbc"></a>Risultati dell'elaborazione (ODBC)
 ...
 Anche le funzioni di catalogo ODBC possono recuperare dati. [SQLColumns](../native-client-odbc-api/sqlcolumns.md) , ad esempio, consente di recuperare dati sulle colonne dell'origine dati. Questi set di risultati possono contenere zero o più righe.  
