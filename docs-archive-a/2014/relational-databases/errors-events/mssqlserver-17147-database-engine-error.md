...
|Nome simbolico|STARTUP_SERVERKILLED|  
|Testo del messaggio|SQL Server verrà terminato a causa dell'arresto del sistema. Questo è un messaggio informativo. Non è richiesta alcuna azione da parte dell'utente.|  
