...
|Nome simbolico|P3_HEKATON_XACT|  
|Testo del messaggio|*construct* '*feature*' non supportato con una transazione attiva che accede alle tabelle con ottimizzazione per la memoria o alle stored procedure compilate in modo nativo.|  
