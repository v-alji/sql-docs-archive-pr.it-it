---
title: Classi del provider WMI per la gestione della configurazione | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="wmi-provider-for-configuration-management-classes"></a>Classi del provider WMI per la gestione della configurazione
 ...
 [Classe ServerNetworkProtocolIPAddress](servernetworkprotocolipaddress-class/servernetworkprotocolipaddress-class.md)  
