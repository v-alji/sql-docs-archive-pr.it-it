...
## <a name="in-this-section"></a>Contenuto della sezione  
 ...
 [Esecuzione di un DiffGram utilizzando ADO &#40;SQLXML 4,0&#41;](executing-a-diffgram-by-using-ado-sqlxml-4-0.md)  
 Viene fornito un esempio relativo all'esecuzione di un Diffgram con oggetti ADO (ActiveX Data Objects).  
  
 [Esecuzione di un DiffGram mediante classi gestite SQLXML](../net-framework-classes/sqlxml-4-0-net-framework-support-managed-classes.md)  
