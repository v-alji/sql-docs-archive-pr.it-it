...
## <a name="see-also"></a>Vedere anche
 [Utilità SQL Server funzionalità e le attività](sql-server-utility-features-and-tasks.md) [risolvono i utilità SQL Server](../../database-engine/troubleshoot-the-sql-server-utility.md)
