 ...
 **Trigger ricorsivi abilitati**  
 ...
 Per impostazione predefinita, questa proprietà è impostata su tutti i database utente e tutti i database di sistema, ad eccezione di **msdb** `False` . Il valore non può essere modificato nel caso dei database **model** e **tempdb** .  
