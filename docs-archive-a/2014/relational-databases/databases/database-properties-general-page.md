 ...
 **Status**  
 Visualizza lo stato del database. Per altre informazioni, vedere [Stati del database](database-states.md).  
 ...
 **Numero di utenti**  
 Consente di visualizzare il numero di utenti connessi al database.  
