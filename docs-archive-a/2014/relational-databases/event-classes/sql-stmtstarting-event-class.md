...
## <a name="sqlstmtstarting-event-class-data-columns"></a>Colonne di dati della classe di evento SQL:StmtStarting  
...
|EventClass|`int`|Tipo di evento = 40.|27|No|  
...
|NestLevel|`int`|Livello di nidificazione della stored procedure se l'istruzione SQL è stata eseguita all'interno di una stored procedure.|29|Sì|  
...
|State|`int`|Indica se l'esecuzione dell'istruzione avviene dopo una ricompilazione.<br /><br /> 1=Ricompilata|30|Sì|  
|TextData|`ntext`|Testo dell'istruzione da eseguire|1|Sì|  
