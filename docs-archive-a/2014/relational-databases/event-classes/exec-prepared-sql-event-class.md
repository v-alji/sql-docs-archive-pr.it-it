...
## <a name="exec-prepared-sql-event-class-data-columns"></a>Colonne di dati della classe di evento Exec Prepared SQL  
...
|EventClass|`int`|Tipo di evento = 72.|27||  
|EventSequence|`int`|Sequenza di un determinato evento all'interno della richiesta.|51||  
|GroupID|`int`|ID del gruppo del carico di lavoro in cui viene generato l'evento di Traccia SQL.|66|Sì|  
|Handle|`int`|Handle dell'istruzione SQL preparata.|33|Sì|  
