...
|EventSubClass|`int`|Tipo di sottoclasse di evento:<br /><br /> 1 = CompPlan Remove. Un piano di query compilato è stato rimosso dalla cache.<br /><br /> 2 = processo di scaricamento della cache. Tutte le voci sono state rimosse dalla cache delle procedure.|21|Sì|  
