...
|**EventClass**|**int**|Tipo di evento = 115.|27|No|  
|**EventSequence**|**int**|Sequenza di un determinato evento all'interno della richiesta.|51|No|  
|**EventSubClass**|**int**|Tipo di sottoclasse di evento.<br /><br /> 1 = Backup<br /><br /> 2 = Ripristino<br /><br /> 3 = Log di backup|21|Sì|  
...
|**TextData**|**ntext**|Testo SQL dell'istruzione di backup o ripristino.|1|Sì|  
