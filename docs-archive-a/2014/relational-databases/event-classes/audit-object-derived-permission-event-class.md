...
|**ObjectName**|**nvarchar**|Nome dell'oggetto creato, modificato o eliminato.|34|Sì|  
...
|**OwnerName**|**nvarchar**|Nome utente del database del proprietario dell'oggetto creato, modificato o eliminato.|37|Sì|  
