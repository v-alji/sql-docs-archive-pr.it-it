...
## <a name="audit-add-login-to-server-role-event-class-data-columns"></a>Colonne di dati della classe di evento Audit Add Login to Server Role  
...
|**DBUserName**|**nvarchar**|Nome dell'utente del database che ha aggiunto o rimosso l'account di accesso.|40|Sì|  
|**EventClass**|**int**|Tipo di evento = 108.|27|No|  
...
|**RoleName**|**nvarchar**|Nome del ruolo predefinito del server di cui viene modificata l'appartenenza.|38|Sì|  
