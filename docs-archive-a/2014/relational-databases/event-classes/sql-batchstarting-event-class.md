...
## <a name="sqlbatchstarting-event-class-data-columns"></a>Colonne di dati della classe di evento SQL:BatchStarting  
...
|EventClass|`int`|Tipo di evento = 13.|27|No|  
...
|TextData|`ntext`|Testo del batch Transact-SQL.|1|Sì|  
