...
## <a name="tm-promote-tran-starting-event-class-data-columns"></a>Colonne di dati della classe di evento TM: Promote Tran Starting  
...
|EventClass|`int`|Tipo di evento = 183.|27|No|  
