...
-   Per un backup parziale, è necessario usare l'istruzione [BACKUP](/sql/t-sql/statements/backup-transact-sql) di [!INCLUDE[tsql](../../includes/tsql-md.md)] con l'opzione PARTIAL.  
