...
1.  Costruire un'istruzione SQL in cui venga utilizzata la sequenza di escape ODBC CALL. Nell'istruzione devono essere utilizzati marcatori di parametro per ogni parametro di input, input/output e output e per il valore restituito della procedura, se disponibile. Per i parametri di input, è possibile utilizzare marcatori di parametro o specificare valori a livello di codice.  
