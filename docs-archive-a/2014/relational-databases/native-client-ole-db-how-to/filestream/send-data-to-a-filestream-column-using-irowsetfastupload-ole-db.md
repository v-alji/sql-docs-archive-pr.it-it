...
ms.locfileid: "87627682"
---
# <a name="send-data-to-a-filestream-column-using-irowsetfastupload-ole-db"></a><span data-ttu-id="c7ce0-102">Inviare dati a una colonna FILESTREAM utilizzando IRowsetFastUpload (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="c7ce0-102">Send Data to a FILESTREAM Column Using IRowsetFastUpload (OLE DB)</span></span>
  <span data-ttu-id="c7ce0-103">In questo esempio viene utilizzata l'interfaccia IRowsetFastUpload per inviare una quantità di dati compresa tra 4 MB e 4 GB a una colonna FILESTREAM.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-103">This sample uses the IRowsetFastUpload interface to send between 4MB and 4GB of data to a filestream column.</span></span>  
  
 <span data-ttu-id="c7ce0-104">Per ulteriori informazioni sulla funzionalità FILESTREAM, vedere [supporto filestream &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="c7ce0-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="c7ce0-105">Esempio</span><span class="sxs-lookup"><span data-stu-id="c7ce0-105">Example</span></span>  
 <span data-ttu-id="c7ce0-106">Prima di compilare ed eseguire questo esempio, abilitare il supporto per FILESTREAM ([Abilitare e configurare FILESTREAM](../../blob/enable-and-configure-filestream.md)).</span><span class="sxs-lookup"><span data-stu-id="c7ce0-106">Before you compile and run this sample, enable FILESTREAM support ([Enable and Configure FILESTREAM](../../blob/enable-and-configure-filestream.md)).</span></span>  
  
 <span data-ttu-id="c7ce0-107">Verificare che nella variabile di ambiente INCLUDE sia presente la directory che contiene sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-107">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="c7ce0-108">Nel server deve essere presente una directory denominata C:\DBFsa in cui verrà creato il database.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-108">The server must have a directory called C:\DBFsa; this is where the sample will create the database.</span></span> <span data-ttu-id="c7ce0-109">L'istanza di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] deve disporre di accesso in scrittura a questo percorso, che è possibile ottenere, ad esempio, eseguendo l'accesso come account di sistema locale.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-109">Your instance of [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] must have write access to this location (for example, log on as a local system account).</span></span>  
  
 <span data-ttu-id="c7ce0-110">Copiare il primo listato di codice e incollarlo in un file denominato ISSHelper.h.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="c7ce0-111">Copiare il secondo listato di codice e incollarlo in un file denominato ISSHelper.cpp.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="c7ce0-112">Copiare il terzo listato di codice e incollarlo in un file denominato IRowsetFastLoadUpload.cpp.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-112">Copy the third code listing and paste it into a file called IRowsetFastLoadUpload.cpp.</span></span>  
  
 <span data-ttu-id="c7ce0-113">Compilare IRowsetFastLoadUpload.cpp, ISSHelper.cpp, ole32.lib e oleaut32.lib.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-113">Compile IRowsetFastLoadUpload.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="c7ce0-114">Quando si esegue questo esempio, è necessario passare il nome di un server oppure un valore per server\nome_istanza, nonché un valore compreso tra 4 MB (0x400001) e 4 GB (0xFFFFFFFF) che indica la quantità di dati da scrivere.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-114">When you run this sample, you must pass the name of a server, or a server\instance_name, as well as a value between 4 MB (0x400001) and 4 GB (0xFFFFFFFF) indicating the amount of data to write.</span></span>  
  
 <span data-ttu-id="c7ce0-115">Il quarto listato di codice ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) consente di eliminare il database creato dall'esempio.</span><span class="sxs-lookup"><span data-stu-id="c7ce0-115">The fourth ([!INCLUDE[tsql](../../../includes/tsql-md.md)]) code listing deletes the database created by this sample.</span></span>  
