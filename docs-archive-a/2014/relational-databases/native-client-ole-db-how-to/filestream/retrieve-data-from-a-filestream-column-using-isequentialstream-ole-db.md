---
title: Recuperare dati da una colonna FILESTREAM usando ISequentialStream (OLE DB) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "87636047"
---
# <a name="retrieve-data-from-a-filestream-column-using-isequentialstream-ole-db"></a><span data-ttu-id="61a4a-102">Recuperare dati da una colonna FILESTREAM utilizzando ISequentialStream (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="61a4a-102">Retrieve Data from a FILESTREAM Column Using ISequentialStream (OLE DB)</span></span>
  <span data-ttu-id="61a4a-103">In questo esempio viene illustrato come utilizzare un'interfaccia ISequentialStream in un'interfaccia ICommandText per recuperare un record singolo da una colonna FILESTREAM.</span><span class="sxs-lookup"><span data-stu-id="61a4a-103">This sample shows uses an ISequentialStream interface in an ICommandText interface to retrieve a single record from a Filestream column.</span></span>  
  
 <span data-ttu-id="61a4a-104">Per ulteriori informazioni sulla funzionalità FILESTREAM, vedere [supporto filestream &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span><span class="sxs-lookup"><span data-stu-id="61a4a-104">For more information on the filestream feature, see [FILESTREAM Support &#40;OLE DB&#41;](../../native-client/ole-db/filestream-support-ole-db.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="61a4a-105">Esempio</span><span class="sxs-lookup"><span data-stu-id="61a4a-105">Example</span></span>  
 <span data-ttu-id="61a4a-106">Verificare che nella variabile di ambiente INCLUDE sia presente la directory che contiene sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="61a4a-106">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
  
 <span data-ttu-id="61a4a-107">Per creare la tabella letta in questo esempio, utilizzare uno degli esempi seguenti:</span><span class="sxs-lookup"><span data-stu-id="61a4a-107">Use one of the following samples to create the table that this sample reads from:</span></span>  
  
-   [<span data-ttu-id="61a4a-108">Inviare dati a una colonna FILESTREAM usando ISequentialStream associato al parametro ICommandText &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="61a4a-108">Send Data to a FILESTREAM Column Using ISequentialStream Bound to ICommandText Parameter &#40;OLE DB&#41;</span></span>](send-data-to-filestream-isequentialstream-bound-to-icommandtext.md)  
  
-   [<span data-ttu-id="61a4a-109">Inviare dati a una colonna FILESTREAM usando IRowsetFastUpload &#40;OLE DB&#41;</span><span class="sxs-lookup"><span data-stu-id="61a4a-109">Send Data to a FILESTREAM Column Using IRowsetFastUpload &#40;OLE DB&#41;</span></span>](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
  
 <span data-ttu-id="61a4a-110">Copiare il primo listato di codice e incollarlo in un file denominato ISSHelper.h.</span><span class="sxs-lookup"><span data-stu-id="61a4a-110">Copy the first code listing and paste it into a file called ISSHelper.h.</span></span>  
  
 <span data-ttu-id="61a4a-111">Copiare il secondo listato di codice e incollarlo in un file denominato ISSHelper.cpp.</span><span class="sxs-lookup"><span data-stu-id="61a4a-111">Copy the second code listing and paste it into a file called ISSHelper.cpp.</span></span>  
  
 <span data-ttu-id="61a4a-112">Copiare il terzo listato di codice e incollarlo in un file denominato ICommandDownload.cpp.</span><span class="sxs-lookup"><span data-stu-id="61a4a-112">Copy the third code listing and paste it into a file called ICommandDownload.cpp.</span></span>  
  
 <span data-ttu-id="61a4a-113">Compilare ICommandDownload.cpp, ISSHelper.cpp, ole32.lib e oleaut32.lib.</span><span class="sxs-lookup"><span data-stu-id="61a4a-113">Compile ICommandDownload.cpp, ISSHelper.cpp, ole32.lib, and oleaut32.lib.</span></span>  
  
 <span data-ttu-id="61a4a-114">Per eseguire l'esempio, è necessario passare un nome di server (o server\nome_istanza).</span><span class="sxs-lookup"><span data-stu-id="61a4a-114">When this sample is run, you must pass a server name (or server\instance_name).</span></span>  
