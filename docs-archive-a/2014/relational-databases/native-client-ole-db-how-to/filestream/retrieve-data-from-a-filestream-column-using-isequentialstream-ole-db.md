...
-   [Inviare dati a una colonna FILESTREAM usando IRowsetFastUpload &#40;OLE DB&#41;](send-data-to-a-filestream-column-using-irowsetfastupload-ole-db.md)  
 ...
 Copiare il terzo listato di codice e incollarlo in un file denominato ICommandDownload.cpp.  
  
 Compilare ICommandDownload.cpp, ISSHelper.cpp, ole32.lib e oleaut32.lib.  
  
 Per eseguire l'esempio, è necessario passare un nome di server (o server\nome_istanza).  
