...
ms.locfileid: "87718120"
---
# <a name="display-column-and-catalog-metadata-for-sparse-columns-ole-db"></a><span data-ttu-id="7a25b-102">Visualizzare i metadati della colonna e del catalogo per le colonne di tipo sparse (OLE DB)</span><span class="sxs-lookup"><span data-stu-id="7a25b-102">Display Column and Catalog Metadata for Sparse Columns (OLE DB)</span></span>
  <span data-ttu-id="7a25b-103">In questo esempio viene creata una tabella con tre colonne, ovvero una colonna di tipo sparse, una colonna non di tipo sparse e una colonna ColumnSet.</span><span class="sxs-lookup"><span data-stu-id="7a25b-103">This sample creates a table with three columns: a sparse column, a column that is not a sparse column, and a columnset column.</span></span> <span data-ttu-id="7a25b-104">Nell'esempio vengono quindi visualizzati i flag OLE DB che indicano i metadati della colonna e del catalogo per la colonna non di tipo sparse e per quella ColumnSet.</span><span class="sxs-lookup"><span data-stu-id="7a25b-104">The sample then displays OLE DB flags showing the column and catalog metadata for the non-sparse column and the columnset column.</span></span>  
  
 <span data-ttu-id="7a25b-105">Questo esempio può essere eseguito solo in [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] o versione successiva.</span><span class="sxs-lookup"><span data-stu-id="7a25b-105">This sample works with [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] or later.</span></span> <span data-ttu-id="7a25b-106">Per ulteriori informazioni sulle colonne di tipo sparse, vedere [supporto di colonne di tipo sparse in SQL Server Native Client](../native-client/features/sparse-columns-support-in-sql-server-native-client.md).</span><span class="sxs-lookup"><span data-stu-id="7a25b-106">For more information about sparse columns, see [Sparse Columns Support in SQL Server Native Client](../native-client/features/sparse-columns-support-in-sql-server-native-client.md).</span></span>  
  
## <a name="example"></a><span data-ttu-id="7a25b-107">Esempio</span><span class="sxs-lookup"><span data-stu-id="7a25b-107">Example</span></span>  
 <span data-ttu-id="7a25b-108">Verificare che nella variabile di ambiente INCLUDE sia presente la directory che contiene sqlncli.h.</span><span class="sxs-lookup"><span data-stu-id="7a25b-108">Make sure your INCLUDE environment variable includes the directory that contains sqlncli.h.</span></span>  
