...
-   Invio di righe di parametri con valori di tabella utilizzando il modello pull nella classe EmployeesRowset. Nel modello pull il consumer fornisce dati su richiesta al provider.  
  
-   Invio di oggetti BLOB come parte di un parametro con valori di tabella nella classe CPhotograph.  
