...
-   Quali sono le dimensioni dei dati di una riga? Tali dimensioni rientrano nel limite di 8.060 byte? Per rispondere a queste domande, utilizzare il calcolo di [row body size] descritto di seguito.  
 ...
 ![Tabella con ottimizzazione per la memoria.](../../database-engine/media/hekaton-guide-1.gif "Tabella con ottimizzazione per la memoria.")  
...
-   Secondo bucket: (John, Parigi), (Jane, Praga)  
 ...
 Un timestamp di fine &#x221e; (Infinity) indica che si tratta della versione attualmente valida della riga. La riga non è stata aggiornata o eliminata dopo la scrittura di questa versione di riga.  
