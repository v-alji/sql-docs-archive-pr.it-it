...
ms.locfileid: "87624152"
---
# <a name="sql-server-management-objects-support-for-in-memory-oltp"></a><span data-ttu-id="7666a-102">Supporto di SQL Server Management Objects per OLTP in memoria</span><span class="sxs-lookup"><span data-stu-id="7666a-102">SQL Server Management Objects Support for In-Memory OLTP</span></span>
  <span data-ttu-id="7666a-103">In questo argomento vengono descritte le modifiche in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Management Objects (SMO) per OLTP in memoria.</span><span class="sxs-lookup"><span data-stu-id="7666a-103">This topic describes changes in [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Management Objects (SMO) for In-Memory OLTP.</span></span>  
  
 <span data-ttu-id="7666a-104">OLTP in memoria è supportato dai seguenti tipi e membri:</span><span class="sxs-lookup"><span data-stu-id="7666a-104">The following types and members support In-Memory OLTP:</span></span>  
...
## <a name="code-sample"></a><span data-ttu-id="7666a-105">Codice di esempio</span><span class="sxs-lookup"><span data-stu-id="7666a-105">Code Sample</span></span>  
 <span data-ttu-id="7666a-106">Questo esempio consente di eseguire le seguenti operazioni:</span><span class="sxs-lookup"><span data-stu-id="7666a-106">This sample does the following:</span></span>  
  
-   <span data-ttu-id="7666a-107">Filegroup e file ottimizzati per la memoria.</span><span class="sxs-lookup"><span data-stu-id="7666a-107">Creates a database with memory-optimized filegroup and memory-optimized file.</span></span>  
  
-   <span data-ttu-id="7666a-108">Una tabella durevole ottimizzata per la memoria con una chiave primaria, un indice non cluster e un indice hash non cluster.</span><span class="sxs-lookup"><span data-stu-id="7666a-108">Creates a durable memory-optimized table with a primary key, nonclustered index, and a nonclustered hash index.</span></span>  
  
-   <span data-ttu-id="7666a-109">Colonne e indici.</span><span class="sxs-lookup"><span data-stu-id="7666a-109">Creates columns and indexes.</span></span>  
  
-   <span data-ttu-id="7666a-110">Un tipo di tabella ottimizzata per la memoria definito dall'utente.</span><span class="sxs-lookup"><span data-stu-id="7666a-110">Creates a user-defined memory-optimized table type.</span></span>  
  
-   <span data-ttu-id="7666a-111">Una stored procedure compilata in modo nativo.</span><span class="sxs-lookup"><span data-stu-id="7666a-111">Creates a natively compiled stored procedure.</span></span>  
  
 <span data-ttu-id="7666a-112">Questo esempio deve fare riferimento ai seguenti assembly:</span><span class="sxs-lookup"><span data-stu-id="7666a-112">This sample needs to reference the following assemblies:</span></span>  
  
-   <span data-ttu-id="7666a-113">Microsoft.SqlServer.Smo.dll</span><span class="sxs-lookup"><span data-stu-id="7666a-113">Microsoft.SqlServer.Smo.dll</span></span>  
  
-   <span data-ttu-id="7666a-114">Microsoft.SqlServer.Management.Sdk.Sfc.dll</span><span class="sxs-lookup"><span data-stu-id="7666a-114">Microsoft.SqlServer.Management.Sdk.Sfc.dll</span></span>  
  
-   <span data-ttu-id="7666a-115">Microsoft.SqlServer.ConnectionInfo.dll</span><span class="sxs-lookup"><span data-stu-id="7666a-115">Microsoft.SqlServer.ConnectionInfo.dll</span></span>  
  
-   <span data-ttu-id="7666a-116">Microsoft.SqlServer.SqlEnum.dll</span><span class="sxs-lookup"><span data-stu-id="7666a-116">Microsoft.SqlServer.SqlEnum.dll</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="7666a-117">Vedere anche</span><span class="sxs-lookup"><span data-stu-id="7666a-117">See Also</span></span>  
 [<span data-ttu-id="7666a-118">Supporto di SQL Server per OLTP in memoria</span><span class="sxs-lookup"><span data-stu-id="7666a-118">SQL Server Support for In-Memory OLTP</span></span>](sql-server-support-for-in-memory-oltp.md)  
