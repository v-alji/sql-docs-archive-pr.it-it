...
## <a name="code-sample"></a>Codice di esempio  
 Questo esempio consente di eseguire le seguenti operazioni:  
  
-   Filegroup e file ottimizzati per la memoria.  
  
-   Una tabella durevole ottimizzata per la memoria con una chiave primaria, un indice non cluster e un indice hash non cluster.  
  
-   Colonne e indici.  
  
-   Un tipo di tabella ottimizzata per la memoria definito dall'utente.  
  
-   Una stored procedure compilata in modo nativo.  
  
 Questo esempio deve fare riferimento ai seguenti assembly:  
