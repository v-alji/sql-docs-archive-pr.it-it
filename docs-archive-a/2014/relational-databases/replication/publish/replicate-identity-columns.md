...
-   Il parametro ** \@ identity_range** , che controlla le dimensioni dell'intervallo di valori Identity inizialmente allocato al server di pubblicazione e ai sottoscrittori con sottoscrizioni client.  
    ...
    > [!NOTE]  
    >  Per i Sottoscrittori che eseguono versioni precedenti di [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] , questo parametro (anziché il parametro ** \@ pub_identity_range** ) controlla anche le dimensioni dell'intervallo di valori Identity nei Sottoscrittori di ripubblicazione.  
