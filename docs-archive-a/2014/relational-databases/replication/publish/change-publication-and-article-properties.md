...
|Modifica dei mapping dei tipi di dati (si applica solo alla pubblicazione Oracle).|**sp_changearticlecolumndatatype**|**\@tipo**<br /><br /> **\@lunghezza**<br /><br /> **\@precisione**<br /><br /> **\@scale**|Nuovo snapshot.<br /><br /> Reinizializzazione delle sottoscrizioni.|  
