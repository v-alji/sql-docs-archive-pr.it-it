...
# <a name="retrieving-error-information"></a>Recupero delle informazioni sugli errori
  In questo esempio vengono ottenute informazioni dalle diverse interfacce di errore esposte dal [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] provider OLE DB di Native Client.  
