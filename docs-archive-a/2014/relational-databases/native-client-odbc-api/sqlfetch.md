...
# <a name="sqlfetch"></a>SQLFetch
 ...
 Per informazioni sul modo in cui i valori della colonna dei risultati dei tipi di data/ora vengono convertiti, vedere [conversioni da SQL a C](../native-client-odbc-date-time/datetime-data-type-conversions-from-sql-to-c.md).  
