...
>  Un'istruzione [!INCLUDE[tsql](../../includes/tsql-md.md)] SELECT contenente una clausola COMPUTE è supportata solo in caso di connessione a una versione server antecedente a [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)].  
 ...
 Lo sviluppatore può determinare le proprietà delle colonne e delle righe dei set di risultati generate dalla clausola COMPUTE di un'istruzione [!INCLUDE[tsql](../../includes/tsql-md.md)] SELECT. Per ulteriori dettagli, vedere [SQLColAttribute](sqlcolattribute.md).  
