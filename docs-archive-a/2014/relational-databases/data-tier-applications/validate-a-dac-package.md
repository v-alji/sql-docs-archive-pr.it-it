...
### <a name="view-database-changes-by-using-powershell"></a>Visualizzare modifiche al database tramite PowerShell
...
##  <a name="compare-dacs"></a><a name="CompareDACs"></a>Confrontare DAC  
