...
|Testo del messaggio|Parametro per il metodo API dell'istanza del database locale non corretto. Consultare la documentazione dell'API.|  
  
## <a name="explanation"></a>Spiegazione  
 Uno o più parametri di input specificati non validi.  
  
## <a name="user-action"></a>Azione dell'utente  
 Verificare i parametri, quindi ripetere l'operazione.  
