...
ms.locfileid: "87725596"
---
# <a name="streaming-support-for-blob-output-parameters"></a><span data-ttu-id="15892-102">Supporto del flusso per parametri di output BLOB</span><span class="sxs-lookup"><span data-stu-id="15892-102">Streaming Support for BLOB Output Parameters</span></span>
  <span data-ttu-id="15892-103">In questo argomento è incluso un esempio in cui viene illustrato il supporto del flusso per parametri di output, che associa parametri di output BLOB come ISequentialStreams.</span><span class="sxs-lookup"><span data-stu-id="15892-103">This topic contains a sample that shows streaming support for BLOB output parameters, which binds BLOB output parameters as ISequentialStreams.</span></span>  
  
 <span data-ttu-id="15892-104">È possibile che i parametri di output vengano bloccati in IMultipleResults::GetResult e che venga restituito il valore DB_E_OBJECTOPEN.</span><span class="sxs-lookup"><span data-stu-id="15892-104">You can become blocked on output parameters in IMultipleResults::GetResult, receiving DB_E_OBJECTOPEN return value.</span></span> <span data-ttu-id="15892-105">Il chiamante deve verificare l'eventuale presenza di parametri BLOB in sospeso e leggerli completamente o rilasciarli.</span><span class="sxs-lookup"><span data-stu-id="15892-105">The caller should to check for pending blob parameters, and either read them completely or release them.</span></span>  
  
## <a name="example"></a><span data-ttu-id="15892-106">Esempio</span><span class="sxs-lookup"><span data-stu-id="15892-106">Example</span></span>  
  
### <a name="code"></a><span data-ttu-id="15892-107">Codice</span><span class="sxs-lookup"><span data-stu-id="15892-107">Code</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="15892-108">Vedere anche</span><span class="sxs-lookup"><span data-stu-id="15892-108">See Also</span></span>  
 [<span data-ttu-id="15892-109">Oggetti BLOB e OLE</span><span class="sxs-lookup"><span data-stu-id="15892-109">BLOBs and OLE Objects</span></span>](blobs-and-ole-objects.md)  
