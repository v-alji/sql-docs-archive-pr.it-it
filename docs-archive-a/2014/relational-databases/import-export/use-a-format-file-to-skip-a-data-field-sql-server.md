...
> [!NOTE]  
>  È possibile utilizzare un file di formato non XML o XML per importare in blocco un file di dati nella tabella utilizzando un comando **bcp** , un'istruzione BULK INSERT o un'istruzione INSERT... Istruzione SELECT * FROM OPENROWSET (BULK...). Per altre informazioni, vedere [Usare un file di formato per l'importazione in blocco dei dati &#40;SQL Server&#41;](use-a-format-file-to-bulk-import-data-sql-server.md).  
