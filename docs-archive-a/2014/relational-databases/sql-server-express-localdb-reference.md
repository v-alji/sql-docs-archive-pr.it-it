...
ms.locfileid: "87629757"
---
# <a name="sql-server-express-localdb-reference"></a><span data-ttu-id="87230-102">Riferimento al database locale di SQL Server Express</span><span class="sxs-lookup"><span data-stu-id="87230-102">SQL Server Express LocalDB Reference</span></span>
  <span data-ttu-id="87230-103">In questa sezione sono contenute informazioni sul database locale di SQL Server Express:</span><span class="sxs-lookup"><span data-stu-id="87230-103">This section contains information about the SQL Server Express LocalDB:</span></span>  
  
-   [<span data-ttu-id="87230-104">Informazioni di riferimento sui messaggi di errore di SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="87230-104">SQL Server Express LocalDB Error Message Reference</span></span>](express-localdb-error-messages/sql-server-express-localdb-reference-error-messages.md)  
  
-   [<span data-ttu-id="87230-105">Informazioni si riferimento sull'API dell'istanza di SQL Server Express LocalDB</span><span class="sxs-lookup"><span data-stu-id="87230-105">SQL Server Express LocalDB Instance API Reference</span></span>](express-localdb-instance-apis/sql-server-express-localdb-reference-instance-apis.md)  
  
## <a name="code-sample"></a><span data-ttu-id="87230-106">Codice di esempio</span><span class="sxs-lookup"><span data-stu-id="87230-106">Code Sample</span></span>  
 <span data-ttu-id="87230-107">Nell'esempio seguente viene illustrata l'API LocalDB.</span><span class="sxs-lookup"><span data-stu-id="87230-107">The following sample demonstrates the LocalDB API.</span></span>  <span data-ttu-id="87230-108">Prima di eseguire questo esempio, verificare che LocalDB sia installata nel computer in uso.</span><span class="sxs-lookup"><span data-stu-id="87230-108">Make sure that LocalDB is installed on the computer before running this sample.</span></span>  <span data-ttu-id="87230-109">È possibile installare LocalDB dal programma di installazione di [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span><span class="sxs-lookup"><span data-stu-id="87230-109">You can install LocalDB from setup in the [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] Express.</span></span>  
