 ...
 **Oggetti sui quali** _\<selected object>_ **dipende da**      
 ...
 **Dipendenze**  
 Se si fa clic su **Oggetti che dipendono da** _\<selected object>_ , vengono visualizzati in ordine gerarchico gli oggetti che dipendono dall'oggetto selezionato. Se si fa clic su **Oggetti da cui** **dipende** _\<selected object>_ , vengono visualizzati in ordine gerarchico gli oggetti da cui l'oggetto selezionato dipende.  
