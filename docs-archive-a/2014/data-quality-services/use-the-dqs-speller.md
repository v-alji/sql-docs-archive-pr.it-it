...
##  <a name="enable-the-speller"></a><a name="Enable"></a>Abilitare il correttore ortografico  
...
##  <a name="use-the-speller"></a><a name="Use"></a> Utilizzare il correttore ortografico  
...
##  <a name="follow-up-after-using-the-speller"></a><a name="FollowUp"></a> Completamento: fasi successive all'utilizzo del correttore ortografico  
...
##  <a name="how-the-speller-works"></a><a name="How"></a> Funzionamento del correttore ortografico  
