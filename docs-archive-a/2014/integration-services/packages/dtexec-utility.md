...
-   **/Va [lidate]**:  
                  facoltativo. Consente di arrestare l'esecuzione del pacchetto dopo la fase di convalida, quindi il pacchetto non viene eseguito. Durante la convalida, l'uso dell'opzione **/warnaserror** fa `dtexec` in modo che consideri un avviso come un errore, pertanto il pacchetto ha esito negativo se si verifica un avviso durante la convalida.  
