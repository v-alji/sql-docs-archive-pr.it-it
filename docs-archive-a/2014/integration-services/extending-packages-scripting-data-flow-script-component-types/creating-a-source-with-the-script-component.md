...
4.  Eseguire l'override del metodo `PostExecute` per completare l'elaborazione dei dati. Ad esempio, è possibile chiudere l'oggetto `SqlDataReader` utilizzato per il caricamento dei dati.
