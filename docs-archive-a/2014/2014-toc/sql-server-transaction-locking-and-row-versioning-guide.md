...
##  <a name="in-this-guide"></a><a name="Top"></a>Contenuto della Guida  
 ...
 [Blocco nel motore di database](#Lock_Engine)  
...
#### <a name="a-working-with-snapshot-isolation"></a>R. Utilizzo dell'isolamento dello snapshot  
