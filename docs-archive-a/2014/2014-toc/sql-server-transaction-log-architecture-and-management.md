...
---
# <a name="sql-server-2014-transaction-log-architecture-and-management"></a>Architettura e gestione del log delle transazioni di SQL Server 2014

**Si applica a:** SQL Server (a partire da 2008)
...
##  <a name="transaction-log-backups"></a><a name="Backups"></a>Backup del log delle transazioni  
