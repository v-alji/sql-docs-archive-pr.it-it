...
5.  In tipo server selezionare **Analysis Services**.  
  
6.  In nome server immettere ** \<server-name> \PowerPivot**, dove **\<server-name>** è il nome del computer in cui è presente l'installazione di PowerPivot per SharePoint.  
