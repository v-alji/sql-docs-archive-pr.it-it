...
##  <a name="error-types-that-cause-an-automatic-page-repair-attempt"></a><a name="ErrorTypes"></a>Tipi di errore che provocano un tentativo di correzione automatica della pagina  
...
##  <a name="page-types-that-cannot-be-automatically-repaired"></a><a name="UnrepairablePageTypes"></a>Tipi di pagina che non possono essere corretti automaticamente  
...
##  <a name="developer-best-practice"></a><a name="DevBP"></a>Procedura consigliata per gli sviluppatori  
