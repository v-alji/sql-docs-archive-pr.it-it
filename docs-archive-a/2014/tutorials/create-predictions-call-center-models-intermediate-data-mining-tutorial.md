...
8.  Fare clic sulla riga per gli operatori di LVL 2, quindi digitare `6` .  
...
6.  Nella finestra di dialogo **Crea query denominata** Digitare per **nome** `Shifts for Call Center` .  
