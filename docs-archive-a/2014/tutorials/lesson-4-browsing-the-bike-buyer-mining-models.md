...
2.  Copiare l'esempio generico di SELECT FROM \<model> . Istruzione CONTENT nella query vuota.  
...
6.  Nella finestra di dialogo **Salva con** nome individuare la cartella appropriata e assegnare al file il nome `SELECT_CONTENT.dmx` .  
...
2.  Copiare l'esempio generico di SELECT FROM \<model> . Istruzione CASEs nella query vuota.  
...
6.  Nella finestra di dialogo **Salva con** nome individuare la cartella appropriata e assegnare al file il nome `SELECT_DRILLTHROUGH.dmx` .  
...
6.  Nella finestra di dialogo **Salva con** nome individuare la cartella appropriata e assegnare al file il nome `SELECT_DISCRETE.dmx` .  
