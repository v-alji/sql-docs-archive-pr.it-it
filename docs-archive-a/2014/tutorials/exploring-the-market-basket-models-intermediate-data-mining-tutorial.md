...
##  <a name="itemsets-tab"></a><a name="bkmk_Itemsets"></a>Scheda set di elementi  
 Il passaggio successivo consiste nell'ottenere maggiori informazioni sulle regole e sui set di elementi generati dal modello per i prodotti Touring Tire e Touring Tire Tube. Nella scheda **set** di elementi vengono visualizzate tre importanti informazioni correlate ai set di elementi [!INCLUDE[msCoName](../includes/msconame-md.md)] individuati dall'algoritmo di associazione:  
...
3.  Fare clic con il pulsante destro del mouse sull'elemento, `Touring Tire` selezionare **drill-through**, quindi selezionare **colonne struttura e modello**.  
