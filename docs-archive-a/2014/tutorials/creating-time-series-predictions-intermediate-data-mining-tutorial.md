...
2.  Nella finestra di dialogo **Salva risultati query di data mining** selezionare per **origine dati** [!INCLUDE[ssSampleDBDWobject](../includes/sssampledbdwobject-md.md)] . Se si desidera salvare i dati in un database relazionale diverso, è inoltre possibile creare una nuova origine dati.  
