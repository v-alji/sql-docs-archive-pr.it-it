...
1.  Nella scheda **modelli di data mining** di fare [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)] clic con il pulsante destro del mouse sul `Association` modello e scegliere **nuovo modello di data mining**.  
...
5.  Fare clic sulla casella di testo **valore** e digitare `High` nella casella.  
...
1.  Nella scheda **modelli di data mining** fare clic con il pulsante destro del mouse sul `Association Filtered` modello e scegliere **proprietà**.  
  
2.  Modificare la proprietà **AllowDrillThrough** in **true**.  
  
3.  Fare clic con il pulsante destro del mouse sul `Association Filtered` modello di data mining e scegliere **Elabora modello**.  
  
4.  Fare clic su **Sì** nel messaggio di errore per distribuire il nuovo modello nel [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] database.  
