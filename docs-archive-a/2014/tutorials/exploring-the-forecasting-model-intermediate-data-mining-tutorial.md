...
##  <a name="charts-tab"></a><a name="bkmk_Charts"></a>Scheda grafici  
 La scheda **grafici** del [!INCLUDE[msCoName](../includes/msconame-md.md)] Visualizzatore Time Series Mostra graficamente ogni serie, inclusi i dati cronologici e le stime. Ogni linea del grafico della serie temporale rappresenta una combinazione univoca di prodotto, area e attributo stimabile.  
...
##  <a name="model-tab"></a><a name="bkmk_Model"></a>Scheda modello  
 La scheda **modello** del [!INCLUDE[msCoName](../includes/msconame-md.md)] Visualizzatore Time Series in Progettazione modelli di data mining consente di visualizzare il modello di previsione sotto forma di grafico ad albero.  
