...
1.  Nella pagina **Crea set di testing** , per la **percentuale di dati per il testing**, lasciare il valore predefinito `30` .  
...
1.  Nella pagina **Completamento procedura guidata** Digitare in **Nome struttura di data mining** `Targeted Mailing` .  
