...
##  <a name="creating-the-new-extended-sales-data"></a><a name="bkmk_newExtendData"></a>Creazione dei nuovi dati di vendita estesi  
...
###  <a name="create-a-data-source-view-using-the-new-sales-data"></a><a name="bkmk_newReplaceData"></a>Creare una vista origine dati utilizzando i nuovi dati di vendita  
...
##  <a name="creating-the-data-for-the-cross-prediction-model"></a><a name="bkmk_CrossData2"></a>Creazione dei dati per il modello di stima incrociata  
...
9. Fare clic con il pulsante destro del mouse sulla `AllRegions` tabella, quindi scegliere **Esplora dati**.  
  
###  <a name="to-create-the-series-data-for-cross-prediction"></a><a name="bkmk_CrossData"></a>Per creare i dati della serie per la stima incrociata  
