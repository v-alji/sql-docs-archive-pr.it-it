 ...
 **/M** _machine1_ [ *COMPUTER2 * * Machinen*] |*@machinelistfile*  
 ...
 *@machinelistfile*L'utilizzo di consente di specificare un nome file di un elenco di computer da archiviare nel file di configurazione.  
