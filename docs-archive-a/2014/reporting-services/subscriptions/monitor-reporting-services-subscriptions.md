...
-   [Gestione delle sottoscrizioni inattive](#bkmk_manage_inactive)  
...
|Operazione completata: \<*number*> elaborazione del \<*number*> totale degli \<*number*> errori.|Consente di visualizzare lo stato di esecuzione di una sottoscrizione guidata dai dati. Questo messaggio viene generato da Elaborazione pianificazione e recapito.|  
...
|\<*number*>totale|Numero totale di notifiche generate per l'ultima operazione di recapito correlata alla sottoscrizione.|  
|\<*number*>errore|Numero di notifiche che Elaborazione pianificazione e recapito non ha potuto recapitare oppure che non tenterà più di recapitare.|  
...
|\<filename>Impossibile scrivere nel file \<path> . Nuovo tentativo in corso.|Indica il mancato aggiornamento del file a una versione più recente. Questo messaggio viene generato dall'estensione per il recapito alla condivisione file.|  
...
##  <a name="managing-inactive-subscriptions"></a><a name="bkmk_manage_inactive"></a>Gestione delle sottoscrizioni inattive  
