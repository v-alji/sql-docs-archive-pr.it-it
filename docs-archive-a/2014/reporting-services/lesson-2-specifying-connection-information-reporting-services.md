...
7.  [!INCLUDE[clickOK](../includes/clickok-md.md)]l'origine dati [!INCLUDE[ssSampleDBnormal](../includes/sssampledbnormal-md.md)] viene aggiunta al riquadro **dei dati del report** .  
