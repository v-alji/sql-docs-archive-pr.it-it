...
-   [!INCLUDE[vsprvsext](../../includes/vsprvsext-md.md)]o versione successiva con la [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] Software Development Kit (SDK) installata.  
