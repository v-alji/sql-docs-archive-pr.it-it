 ...
 **Server di report in modalità nativa:** In un'installazione in modalità nativa, l'URL predefinito verrà formato http:// \<*computername*> /reportserver/reportbuilder/ReportBuilder_3_0_0_0. Application.  
