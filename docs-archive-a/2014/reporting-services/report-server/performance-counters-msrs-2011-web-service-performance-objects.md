...
-   [Contatori delle prestazioni per l'oggetto prestazioni MSRS 2014 Web Service](#bkmk_webservice)

-   [Contatori delle prestazioni per l'oggetto prestazioni MSRS 2014 Windows Service](#bkmk_windowsservice)

-   [Utilizzare i cmdlet di PowerShell per restituire gli elenchi](#bkmk_powershell)

##  <a name="msrs-2014-web-service-performance-counters"></a><a name="bkmk_webservice"></a>Contatori delle prestazioni del servizio Web MSRS 2014
...
##  <a name="msrs-2014-windows-service-performance-counters"></a><a name="bkmk_windowsservice"></a>Contatori delle prestazioni del servizio Windows MSRS 2014
