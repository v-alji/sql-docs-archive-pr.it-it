...
2.  Scegliere **Proprietà** dal menu **Progetto**. Verrà visualizzata la finestra di _\<project>_ dialogo **pagine delle proprietà** .  
...
5.  Opzionale Per **TargetDataSourceFolder**, digitare l'URL di una raccolta di SharePoint o di una cartella della raccolta, ad esempio *http://TestServer/TestSite/Documents/DataSources)* .  
