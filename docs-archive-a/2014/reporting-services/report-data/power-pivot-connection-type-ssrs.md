...
## <a name="connection-string"></a>Connection String  
 La stringa di connessione è l'URL della cartella di lavoro di PowerPivot pubblicata in SharePoint nella raccolta PowerPivot o in un'altra libreria, ad esempio http://contoso-srv/subsite/PowerPivotLibrary/ContosoSales.xlsx .  
