...
3.  In **didascalia**Digitare il testo che si desidera visualizzare come messaggio nel campo della `NoDataMessage` Proprietà.  
...
2.  Nel riquadro proprietà `NoDataText` digitare il testo che si desidera visualizzare come etichetta per i colori senza valore di dati.  
