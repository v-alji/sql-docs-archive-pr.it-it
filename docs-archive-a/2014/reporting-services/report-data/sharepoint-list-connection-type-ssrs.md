...
|Elenco SharePoint remoto|Autenticazione di Windows (integrata) o token utente di SharePoint|Sì|No<sup>2</sup>|  
||Archiviate, su richiesta, nessuna (con le credenziali di Windows<sup>1</sup>)|Sì|No<sup>2</sup>|  
...
||Archiviate, su richiesta, nessuna (con le credenziali di Windows<sup>1</sup>)|No|No<sup>2</sup>|  
 ...
 <sup>1</sup> le credenziali archiviate e richieste con credenziali non Windows non sono supportate.  
 ...
 <sup>3</sup> autenticazione di Windows, autenticazione basata su form (FBA), token SAML (Secure Application Markup Language), altri provider di identità o una combinazione di più provider di autenticazione menzionati in precedenza.  
 ...
 **Credenziali non richieste (Non usare credenziali):**  
 ...
 Per ulteriori informazioni, vedere [connessioni dati, origini dati e stringhe di connessione in Reporting Services](../data-connections-data-sources-and-connection-strings-in-reporting-services.md), [specificare le credenziali in Generatore report](../specify-credentials-in-report-builder.md)e [origini dati supportate da Reporting Services &#40;SSRS&#41;](../create-deploy-and-manage-mobile-and-paginated-reports.md).  
