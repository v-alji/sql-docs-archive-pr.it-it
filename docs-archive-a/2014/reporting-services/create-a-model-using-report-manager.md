...
8.  Selezionare il metodo di connessione che gli utenti di Generatore report dovranno utilizzare per connettersi al database.  
    ...
    -   [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Autenticazione: selezionare questa opzione se si desidera che gli utenti usino un [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] account di accesso creato. Gli utenti dovranno fornire un nome e una password di accesso validi per [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] .  
