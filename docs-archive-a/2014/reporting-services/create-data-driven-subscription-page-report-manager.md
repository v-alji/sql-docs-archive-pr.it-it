 ...
 **Nome utente**  
 Immettere l'account utente di dominio che dispone delle autorizzazioni per aggiungere file alla cartella condivisa nel formato seguente: \<domain> \\<nome utente \> .  
