...
>  Per impostazione predefinita, la rappresentazione è disabilitata.  
 ...
 Per ulteriori informazioni sulla [!INCLUDE[vstecasp](../../includes/vstecasp-md.md)] rappresentazione, vedere la documentazione di [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] SDK.  
