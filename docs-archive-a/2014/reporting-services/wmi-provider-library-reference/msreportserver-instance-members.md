...
---
# <a name="msreportserver_instance-members"></a>Membri di MSReportServer_Instance
...
|||  
|-|-|  
|[EditionID](msreportserver-instance-properties-editionid.md)|Restituisce l'edizione del server di report.|  
