...
## <a name="remarks"></a>Osservazioni  
 ...
 Se la proprietà di [inizializzazione](configurationsetting-property-isinitialized.md) del server di report è impostata su `true` quando viene chiamato il metodo InitializeReportServer, il metodo restituisce l'esito positivo senza provare a crittografare la chiave di crittografia.  
