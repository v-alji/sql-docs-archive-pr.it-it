...
## <a name="example"></a>Esempio  
 Per eseguire il codice seguente, aggiungere il nome del server al posto di ognuno di essi \<*servername*> . Aggiornare il percorso in modo che punti al percorso di installazione, se non è l'impostazione predefinita. L'esempio di codice seguente esegue l’iterazione di ogni proprietà nella classe [MSReportServer_ConfigurationSetting](msreportserver-configurationsetting-class.md) , stampandone il nome e il relativo valore nella console.  
