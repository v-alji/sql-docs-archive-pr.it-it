...
---
# <a name="setsecureconnectionlevel-method-wmi-msreportserver_configurationsetting"></a>Metodo SetSecureConnectionLevel (MSReportServer_ConfigurationSetting WMI)
...
-   Quando il valore è impostato, l'elemento SecureConnectionLevel nel file di configurazione del server di report viene modificato e l' `URLRoot` elemento nel file di configurazione viene impostato per utilizzare "https://" Se il *livello* specificato è maggiore o uguale a 1 oppure "http://" Se il *livello* specificato è 0.  
