...
---
# <a name="smtpserver-property-wmi-msreportserver_configurationsetting"></a>Proprietà SMTPServer (MSReportServer_ConfigurationSetting WMI)
...
## <a name="property-values"></a>Valori della proprietà  
 Oggetto di sola lettura `String` che contiene il valore della proprietà `SMTPServer` dal file RSReportServer.config.  
