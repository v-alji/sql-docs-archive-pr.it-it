...
## <a name="see-also"></a>Vedere anche
 [Gestione avvisi dati per gli amministratori di](../../2014/reporting-services/data-alert-manager-for-alerting-administrators.md) avvisi [Reporting Services avvisi dati](../ssms/agent/alerts.md)
