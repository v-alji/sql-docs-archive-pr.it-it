 ...
 **Specificare un report**  
 ...
 Per un report pubblicato in un server di report configurato per la modalità integrata SharePoint, utilizzare un URL completo, inclusa l'estensione del nome di file (RDL). Ad esempio, http:// *\<SharePointservername>/\<site>* /Documents/Report1.rdl. I percorsi relativi non sono supportati.  
