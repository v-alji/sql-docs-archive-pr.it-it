...
##  <a name="components-that-provide-integration"></a><a name="bkmk_components"></a>Componenti che forniscono l'integrazione
 ...
 Per combinare i server in un'unica distribuzione, è necessario integrare un'installazione di [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] con un'istanza di prodotti SharePoint  
