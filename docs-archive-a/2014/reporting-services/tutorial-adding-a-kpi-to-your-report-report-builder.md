...
1.  Nella tabella fare clic con il pulsante destro del mouse su due celle verso il basso dalla `[Sum(Sales)]` cella, ovvero la riga del subtotale in cui sono visualizzate le vendite per una sottocategoria, quindi fare clic su **Proprietà casella di testo**.  
