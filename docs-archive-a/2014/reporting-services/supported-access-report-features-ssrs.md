...
|||||  
|-|-|-|-|  
|Immagine|Etichetta|Linea|Rettangolo|  
...
|IsHyperlink|IsVisible|StampaSezioneUnita (gruppo)|Sinistra|  
...
|||||  
|-|-|-|-|  
|Media|Conteggio|Max|Min|  
|StDev|StDevP|Somma|Var|  
|VarP||||  
...
|LCase|LCase$|Sinistra|Left$|  
|Len|LTrim|LTrim$|Mid|  
|Mid$|Sostituisci|Destra|Right$|  
