...
2.  Il servizio Web effettua una chiamata al <xref:ReportService2010.ReportingService2010.LogonUser%2A> metodo dell'estensione di sicurezza, in particolare, la classe che implementa **IAuthenticationExtension**.  
