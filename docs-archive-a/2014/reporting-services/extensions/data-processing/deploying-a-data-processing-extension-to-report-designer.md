...
4.  Aggiungere una voce per l'estensione per l'elaborazione dati che includa un elemento **Extension** con i valori per gli `Name` `Type` attributi, e `Visible` . La voce può essere simile alla seguente:  
