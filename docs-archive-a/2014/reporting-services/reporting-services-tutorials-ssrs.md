...
# <a name="reporting-services-tutorials-ssrs"></a>Esercitazioni su Reporting Services (SSRS)
  In questa sezione sono disponibili le esercitazioni per il [!INCLUDE[ssSQL11](../includes/sssql11-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)].  
 ...
 [Accesso al servizio Web ReportServer utilizzando Visual Basic o Visual C&#35; &#40;SSRS tutorial&#41;](../tutorials/access-report-server-web-service-vb-vcsharp-ssrs-tutorial.md)  
 Eseguire la procedura descritta in questa esercitazione per informazioni su come accedere ai [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)] servizi Web da un'applicazione creata con [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)] o [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[csprcs](../includes/csprcs-md.md)] .  
 ...
 Eseguire la procedura descritta in questa esercitazione per apprendere come utilizzare lo strumento XML Schema Definition (Xsd.exe) per generare classi che consentono di serializzare e deserializzare i file di definizione dei report (con estensione rdl e rdlc) con [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] .  
...
## <a name="see-also"></a>Vedere anche  
 ...
 [Set di dati picnic (dati di esempio) (https://go.microsoft.com/fwlink/?linkID=219108)](https://go.microsoft.com/fwlink/?linkID=219108)  
