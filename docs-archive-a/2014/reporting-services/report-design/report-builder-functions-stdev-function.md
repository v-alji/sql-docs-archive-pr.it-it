...
---
# <a name="stdev-function-report-builder-and-ssrs"></a>Funzione StDev (Generatore report e SSRS)
...
## <a name="example"></a>Esempio  
 L'esempio di codice seguente consente di ottenere la deviazione standard dei totali degli elementi nel gruppo o nell'area dati `Order` .  
