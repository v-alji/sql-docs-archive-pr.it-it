...
2.  Selezionare l'area dati nell'area di progettazione, quindi fare clic con il pulsante destro del mouse su _\<data region>_ **Proprietà**. Per un misuratore, selezionare **Proprietà pannello del misuratore**. Verrà visualizzata la finestra di _\<data region>_ dialogo **Proprietà** .  
