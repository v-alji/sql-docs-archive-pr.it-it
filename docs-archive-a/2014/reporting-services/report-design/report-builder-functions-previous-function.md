...
## <a name="remarks"></a>Osservazioni  
 ...
 Se l' *espressione* non contiene un'aggregazione, per `Previous` impostazione predefinita la funzione viene impostata sull'ambito corrente per l'elemento del report.  
