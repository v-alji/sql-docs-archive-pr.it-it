...
> [!NOTE]  
>  Per ulteriori informazioni sul download di report di esempio, vedere [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [Generatore report e progettazione report report di esempio](https://go.microsoft.com/fwlink/?LinkId=198283).  
>   
