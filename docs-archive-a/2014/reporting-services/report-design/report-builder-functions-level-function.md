...
## <a name="return-type"></a>Tipo restituito  
 Restituisce un valore `Integer`. Se *scope* specifica un set di dati o un'area dati oppure un raggruppamento non ricorsivo, ovvero un raggruppamento senza `Parent` elemento, `Level` restituisce 0. Se *scope* viene omesso, restituisce il livello dell'ambito corrente.  
