...
### <a name="hyperlinks-and-drillthrough"></a>Collegamenti ipertestuali e collegamenti drill-through  
 Il rendering dei collegamenti ipertestuali e dei collegamenti drill-through viene eseguito come collegamenti ipertestuali negli elementi del report utilizzando i tag di ancoraggio HTML ( \<a> ) intorno all'elemento in cui sono definiti.  
