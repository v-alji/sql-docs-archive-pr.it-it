...
# <a name="report-sections-dialog-box-report-builder"></a>Finestra di dialogo Sezione del report (Generatore report)
  Quando si apre un report, Generatore report verifica che il report contenga un solo elemento Report Definition Language (RDL) **\<Section>** . L'apertura di un report con più **\<Section>** elementi non è supportata.  
