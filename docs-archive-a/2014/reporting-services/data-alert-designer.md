...
-   Ogni giorno **ogni 10** giorni: invia gli avvisi una volta al giorno, ogni 10 giorni.
...
### <a name="email-settings"></a>Impostazioni posta elettronica
 ...
 L'oggetto predefinito del messaggio di posta elettronica è **avviso \<alert name> dati per **. È possibile modificare l'oggetto in base alle proprie esigenze.
