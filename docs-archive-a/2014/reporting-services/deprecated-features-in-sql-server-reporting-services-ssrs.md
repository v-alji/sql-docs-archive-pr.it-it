...
#### <a name="sql-server-2005-and-earlier-custom-report-items"></a>Elementi di report personalizzati di SQL Server 2005 e versioni precedenti  
 Gli elementi del report personalizzati compilati per [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] 2005 e versioni precedenti sono deprecati.  
...
#### <a name="report-models"></a>Modelli di report  
 ...
 [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]non [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] include strumenti per la creazione o l'aggiornamento di modelli di report. Per ulteriori informazioni, vedere [modifiche di rilievo nelle SQL Server Reporting Services SQL Server 2014](breaking-changes-in-sql-server-reporting-services-in-sql-server-2016.md).  
